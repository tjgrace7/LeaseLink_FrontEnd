        ...
        <div className="grid gap-8 md:grid-cols-5">
          <div className="md:col-span-3 rounded-2xl border border-white/10 bg-white/5 p-6 shadow-lg backdrop-blur">
            ...
            <p className="mt-1 text-sm text-white/70">
              We’re inviting <span className="font-medium text-emerald-500">5 commercial property managers</span> to try LeaseLink for free.
              You must manage <span className="font-medium text-emerald-500">100+ units</span>.
            </p>

            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="name" className="block text-sm text-white/70">Full Name*</label>
                  <input
                    id="name"
                    name="name"
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm text-white/70">Work Email*</label>
                  <input
                    id="email"
                    name="email"
                    type="email"
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  <label htmlFor="units" className="block text-sm text-white/70">Units Managed*</label>
                  <input
                    id="units"
                    name="units"
                    type="number"
